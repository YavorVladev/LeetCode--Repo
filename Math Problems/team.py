...
# Long before the start the friends decided that they will implement a problemif at least
...
# each integer is either 0 or 1. If the first number in the line equals 1, then Petya is
# sure about the problem's solution, otherwise he isn't sure. The second number shows Vasya's view
...
for _ in range(n):
    all_p = [int(x) for x in input().split()]
